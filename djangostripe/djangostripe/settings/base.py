...
SECRET_KEY = os.getenv(
    "SECRET_KEY", "django-insecure-4ib93s^ln+(l86!7rz&k2n)%_e$b)@ag*wl5uq*@se5-g8(-*2"
)

ALLOWED_HOSTS = os.getenv("ALLOWED_HOSTS", "127.0.0.1").split(",")

CSRF_TRUSTED_ORIGINS = os.getenv("ALLOWED_ORIGINS", "http://127.0.0.1:8000").split(",")
...
LOGGING = {
    ...
    "formatters": {
        "default": {"format": "{asctime} {levelname}: {message}", "style": "{"}
    },
    "loggers": {
